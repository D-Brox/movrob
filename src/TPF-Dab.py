...
from planners.Swarm import DabSwarm
...
class SwarmNode(Node):
    def __init__(self,mode,n_robots=10,n_classes=4):
        ...
        self.planner = DabSwarm(mode,n_robots,n_classes)
