...
from planners.Swarm import Swarm
...
class SwarmNode(Node):
    def __init__(self,mode,n_robots=10,n_classes=4):
        ...
        self.planner = Swarm(mode,n_robots,n_classes)
        for i in range(n_robots*n_classes):
        ...
        self.multi_sub = TimeSynchronizer(self.sub,n_robots*n_classes)
